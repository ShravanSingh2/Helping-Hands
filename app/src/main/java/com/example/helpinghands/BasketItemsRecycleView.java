...
public class BasketItemsRecycleView extends RecyclerView.Adapter<BasketItemsRecycleView.ViewHolder> {
    ...
    BasketItemsRecycleView(Context context, List<String> idList, List<String> nameList, List<String> userNeedList) {
